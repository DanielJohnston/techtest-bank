...
describe Statement do
  describe '#print' do
    ...
    it 'prints a deposit and balance involving pennies' do
      deposit_1000_and_fifty = double(type: :credit, amount: 1000.5, time: Time.new(2012, 1, 10))
      transactions = [deposit_1000_and_fifty]
      balance = 1000.5
